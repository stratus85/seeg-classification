def get_channel_setting(pn):
    if pn==2:
        ...
        UseChn = [*range(0, 18)] + [18] + [*range(20, 37)] + [*range(45, 153)]
        TrigChn = [37, 38, 39, 40, 41]
        fs=2000
        ...
        UseChn = [*range(0, 18)] + [18] + [*range(20, 37)] + [*range(45, 146)]
        TrigChn = [37,38,39,40,41]
        fs=2000
        ...
        UseChn = [*range(0, 18)] + [18] + [*range(20, 37)] + [45,46] + [*range(49, 67)]
        TrigChn = [37, 38, 39, 40, 41]
        fs=2000
        ...
        UseChn = [*range(0, 18)] + [18] + [*range(20, 37)] + [*range(53, 207)]
